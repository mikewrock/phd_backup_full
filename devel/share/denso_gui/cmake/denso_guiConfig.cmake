  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'denso_gui' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Hosmar <michael.hosmar@uoit.net>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'denso_gui' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/catkin_ws/src/denso_gui/${idir}'.  Ask the maintainer 'Michael Hosmar <michael.hosmar@uoit.net>' to fix it.")
    endif()
