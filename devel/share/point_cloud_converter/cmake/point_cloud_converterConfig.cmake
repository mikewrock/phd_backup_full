...
if("TRUE" STREQUAL "TRUE")
  set(point_cloud_converter_SOURCE_PREFIX /home/mike/catkin_ws/src/point_cloud_converter-hydro-devel)
  set(point_cloud_converter_DEVEL_PREFIX /home/mike/catkin_ws/devel)
  ...
  set(point_cloud_converter_INSTALL_PREFIX /home/mike/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_cloud_converter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/catkin_ws/src/point_cloud_converter-hydro-devel/${idir}'.  Ask the maintainer 'Sammy Pfeiffer <sam.pfeiffer@pal-robotics.com>' to fix it.")
    endif()
