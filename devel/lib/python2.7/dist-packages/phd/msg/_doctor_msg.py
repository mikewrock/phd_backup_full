...
"""autogenerated by genpy from phd/doctor_msg.msg. Do not edit."""
import sys
...
class doctor_msg(genpy.Message):
  _md5sum = "66228b48ce9bd39753227bf3d658616e"
  _type = "phd/doctor_msg"
...
"""
  __slots__ = ['cloud_out','transform_mat','x','y','z','id']
  _slot_types = ['sensor_msgs/PointCloud2','float64[16]','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       cloud_out,transform_mat,x,y,z,id
    ...
    """
    if args or kwds:
      super(doctor_msg, self).__init__(*args, **kwds)
