...
"""autogenerated by genpy from phd/simple_trajectory_serviceRequest.msg. Do not edit."""
import sys
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from phd/simple_trajectory_serviceResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(simple_trajectory_serviceResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
