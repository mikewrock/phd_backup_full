...
"""autogenerated by genpy from phd/doctor_cloudRequest.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(doctor_cloudRequest, self).__init__(*args, **kwds)
...
class doctor_cloudResponse(genpy.Message):
  _md5sum = "2f19691a84376a2883697fa8233da957"
  _type = "phd/doctor_cloudResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """doctor_msg[] clouds
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(doctor_cloudResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.clouds:
        ...
        buff.write(_struct_16d.pack(*val1.transform_mat))
        _x = val1
        buff.write(_struct_4f.pack(_x.x, _x.y, _x.z, _x.id))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.transform_mat = _struct_16d.unpack(str[start:end])
        _x = val1
        start = end
        end += 16
        (_x.x, _x.y, _x.z, _x.id,) = _struct_4f.unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.clouds:
        ...
        buff.write(val1.transform_mat.tostring())
        _x = val1
        buff.write(_struct_4f.pack(_x.x, _x.y, _x.z, _x.id))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.transform_mat = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=16)
        _x = val1
        start = end
        end += 16
        (_x.x, _x.y, _x.z, _x.id,) = _struct_4f.unpack(str[start:end])
