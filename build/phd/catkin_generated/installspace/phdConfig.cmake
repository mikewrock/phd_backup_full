...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phd' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/catkin_ws/install/${idir}'.  Ask the maintainer 'mike wrock <mike.w.rock@gmail.com>' to fix it.")
    endif()
