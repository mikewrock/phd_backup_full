...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_cloud_converter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/catkin_ws/install/${idir}'.  Ask the maintainer 'Sammy Pfeiffer <sam.pfeiffer@pal-robotics.com>' to fix it.")
    endif()
