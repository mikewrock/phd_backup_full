...
main (int argc, char** argv)
{
  ...
  pub2 = nh.advertise<sensor_msgs::PointCloud2> ("aligned_2", 1);

  //* load a file
    if (pcl::io::loadPCDFile<pcl::PointXYZI> ("/home/mike/marker/pcd3.pcd", *cloudA) == -1) 
    {
...
pcl::io::savePCDFileASCII ("/home/mike/filterA.pcd", *cloudA_filtered);
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZI> ("/home/mike/marker/pcd4.pcd", *cloudB) == -1) 
  //* load a file
  {
    PCL_ERROR ("Couldn't read file test_pcd.pcd \n");
